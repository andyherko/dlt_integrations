...
# MAGIC
# MAGIC Your pipeline has been created! You can directly access the <a dbdemos-pipeline-id="sdp-test" href="#joblist/pipelines/4279cd54-f7ad-4c52-8c96-d4ecc28c342f">Spark Declarative Pipelines for unit-test demo</a>.
# MAGIC
# MAGIC <!-- Collect usage data (view). Remove it to disable collection. View README for more details.  -->
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=7474644392943630&notebook=%2FSDP-pipeline-to-test&demo_name=declarative-pipeline-unit-test&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fdeclarative-pipeline-unit-test%2FSDP-pipeline-to-test&version=1">
...
# MAGIC %md
# MAGIC Open the [/sdp-python/transformations/01-bronze.py]($./sdp-python/transformations/01-bronze.py) to check out the full bronze layer code.
# MAGIC
...
# MAGIC %md
# MAGIC Open the [/sdp-python/transformations/02-silver.py]($./sdp-python/transformations/02-silver.py) to check out the full silver layer code.
...
# MAGIC %md
# MAGIC Open the [/sdp-python/transformations/03-gold.py]($./sdp-python/transformations/03-gold.py) to check out the full gold layer code.

# COMMAND ----------

# MAGIC %md
# MAGIC # Our pipeline is now ready to be tested!
# MAGIC
