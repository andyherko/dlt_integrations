...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=7474644392943630&notebook=%2Ftest%2FSDP-Test-Dataset-setup&demo_name=declarative-pipeline-unit-test&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fdeclarative-pipeline-unit-test%2Ftest%2FSDP-Test-Dataset-setup&version=1">

# COMMAND ----------

catalog = "lakehouse_dev"
schema = dbName = db = "cloudwatch_metrics_pull"
...
#dbutils.fs.rm("/Volumes/lakehouse_dev/cloudwatch_metrics_pull/raw_data/test/customers/users_json", True)
#dbutils.fs.mkdirs("/Volumes/lakehouse_dev/cloudwatch_metrics_pull/raw_data/test/users_json")
#dbutils.fs.mkdirs("/Volumes/lakehouse_dev/cloudwatch_metrics_pull/raw_data/test/spend_csv")

#import shutil
#shutil.copyfile("./dataset/users.json", "/Volumes/lakehouse_dev/cloudwatch_metrics_pull/raw_data/test/users_json/users.json")
...
dbutils.fs.put('/Volumes/lakehouse_dev/cloudwatch_metrics_pull/raw_data/test/spend_csv/spend.csv', spend_csv, True)
...
dbutils.fs.put('/Volumes/lakehouse_dev/cloudwatch_metrics_pull/raw_data/test/users_json/users.json', users_json, True)
...
# MAGIC %fs head /Volumes/lakehouse_dev/cloudwatch_metrics_pull/raw_data/test/users_json/users.json
...
# MAGIC %fs head /Volumes/lakehouse_dev/cloudwatch_metrics_pull/raw_data/test/spend_csv/spend.csv
